...
// Serve static files from public/ (for local dev only — Vercel serves from outputDirectory)
...
// Local dev: serve index.html for root
// Serve index.html at root (local dev only — Vercel uses rewrites in vercel.json)
if (!isVercel) {
  app.get("/", (req, res) => {
